...
public class TC03_ChangeEmail {
	...
	UpdateEmailPage updateMailpage;
	...
	public void signUpAnAccount() throws IOException {
		...
		personpage.changeEmail();
		updateMailpage = new UpdateEmailPage(driver);
		updateMailpage.updateNewEmail(updateEmail);
	...
	public void initiateDataForTesting() throws IOException {
		...
		updateEmail=data.getUpdateEmail();
